...
namespace Xlent.Lever.Libraries2.Core.Storage.Model
{
    ...
    public interface IManyToManyRelation<TReferenceModel1, TReferenceModel2, in TId>
    {
        ...
        Task<PageEnvelope<TReferenceModel2>> ReadReferencedItemsByReference1WithPagingAsync(TId id, int offset, int? limit = null);
        ...
        /// <param name="offset">The number of items that will be skipped in result.</param>
        /// <param name="limit">The maximum number of items to return.</param>
        Task<PageEnvelope<TReferenceModel1>> ReadReferencedItemsByReference2WithPagingAsync(TId id, int offset, int? limit = null);
