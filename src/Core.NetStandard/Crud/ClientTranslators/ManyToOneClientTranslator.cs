...
namespace Xlent.Lever.Libraries2.MoveTo.Core.ClientTranslators
{
    ...
    where TModel : IValidatable
    {
        ...
        /// <inheritdoc />
        public ManyToOneClientTranslator(IManyToOneRelation<TModel, string> storage, string idConceptName, System.Func<string> getClientNameFunction, ITranslatorService translatorService)
        :base(idConceptName, getClientNameFunction, translatorService)
        {
            _storage = storage;
        }
