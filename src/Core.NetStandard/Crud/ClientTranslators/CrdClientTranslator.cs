...
namespace Xlent.Lever.Libraries2.MoveTo.Core.ClientTranslators
{
    ...
    where TModel : IValidatable
    {
        ...
        /// <inheritdoc />
        public CrdClientTranslator(ICrd<TModel, string> storage, string idConceptName, System.Func<string> getClientNameFunction, ITranslatorService translatorService)
