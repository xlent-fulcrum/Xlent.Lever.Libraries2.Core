...
namespace Xlent.Lever.Libraries2.Core.Crud.Interfaces
{
    ...
    /// </summary>
    public interface ISlaveToMasterComplete<TModel, TId> : ISlaveToMasterComplete<TModel, TModel, TId>
    {
    }
    ...
    /// Examples: A list of rows on an invoice, a list of attributes of an object, the contact details of a person.
    /// </summary>
    public interface ISlaveToMasterComplete<in TModelCreate, TModel, TId> : IManyToOneRelation<TModel, TId>, IRud<TModel, SlaveToMasterId<TId>>
