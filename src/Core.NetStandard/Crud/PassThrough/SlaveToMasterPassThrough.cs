...
namespace Xlent.Lever.Libraries2.Core.Crud.PassThrough
{
    ...
    public class SlaveToMasterPassThrough<TModelCreate, TModel, TId> : RudPassThrough<TModel, SlaveToMasterId<TId>>, ISlaveToMaster<TModelCreate, TModel, TId> where TModel : TModelCreate
    {
