...
namespace Xlent.Lever.Libraries2.Core.Crud.Cache
{
    ...
    public class ManyToOneAutoCacheComplete<TManyModelCreate, TManyModel, TId> : CrudAutoCache<TManyModelCreate, TManyModel, TId>, IManyToOneRelationComplete<TManyModelCreate, TManyModel, TId>
    {
        ...
        public ManyToOneAutoCacheComplete(IManyToOneRelationComplete<TManyModelCreate, TManyModel, TId> storage, IDistributedCache cache, FlushCacheDelegateAsync flushCacheDelegateAsync = null, AutoCacheOptions options = null)
        ...
        /// <param name="flushCacheDelegateAsync"></param>
        /// <param name="options"></param>
        public ManyToOneAutoCacheComplete(IManyToOneRelationComplete<TManyModelCreate, TManyModel, TId> storage, GetIdDelegate<TManyModel, TId> getIdDelegate, IDistributedCache cache, FlushCacheDelegateAsync flushCacheDelegateAsync = null, AutoCacheOptions options = null)
